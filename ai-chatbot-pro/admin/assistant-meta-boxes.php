...
function aicp_render_instructions_tab($v) {
    ...
    <table class="form-table">
        ...
        <tr><th><label for="aicp_template_select"><?php _e('Plantilla', 'ai-chatbot-pro'); ?></label></th><td><select id="aicp_template_select"><option value=""><?php _e('—', 'ai-chatbot-pro'); ?></option><option value="basic_sales"><?php _e('Asistente de ventas básico', 'ai-chatbot-pro'); ?></option></select></td></tr>
